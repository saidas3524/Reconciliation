...
export const setAvailableLanguages = makeActionCreator(SET_AVAILABLE_LANGUAGES,"localLanguages");


export const SET_LANGUAGE_AND_LOCALIZATION = "PLATFORM/SET_LANGUAGE_AND_LOCALIZATION";
export const setLanguagesAndLocalization = makeActionCreator(SET_LANGUAGE_AND_LOCALIZATION);